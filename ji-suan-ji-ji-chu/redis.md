...
保存元素的容器是一个 contents 数组，虽然 contents 被声明为 int8\_t 类型的数组，但是实际上 contents 数组并不保存任何 int8\_t 类型的元素，contents 数组的真正类型取决于 intset 结构体里的 encoding 属性的值
...
![image-20240109112211828](../.gitbook/assets/image-20240109112211828.png)
...
![image-20240109095346611](../.gitbook/assets/image-20240109095346611.png)
...
![image-20231221181207984](../.gitbook/assets/image-20231221181207984.png)
...
![image-20240127171356393](../.gitbook/assets/image-20240127171356393.png)
...
![image-20240109135256499](../.gitbook/assets/image-20240109135256499.png)
...
![image-20240109135510105](../.gitbook/assets/image-20240109135510105.png)

### Redis单线程模式是怎样的

![image-20240109135554651](../.gitbook/assets/image-20240109135554651.png)
...
Redis 6.0 版本之后，Redis 在启动的时候，默认情况下会额外创建 6 个线程（_这里的线程数不包括主线程_）：
...
![image-20240109140601614](../.gitbook/assets/image-20240109140601614.png)
...
![image-20240109150725369](../.gitbook/assets/image-20240109150725369.png)
...
![image-20240127170523515](../.gitbook/assets/image-20240127170523515.png)
